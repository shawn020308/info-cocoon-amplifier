<p align="center">
  <img src="https://img.shields.io/badge/版本-0.2.1-blue?style=flat-square" alt="version" />
...
| 📊 统计面板 | 扫描数、过滤数、Token 消耗、预估费用、违规严重度分布 |
| ⚙️ 自定义 Prompt | 自由编写过滤规则，支持/反对立场可直接写进 Prompt |
| 🎯 自定义判定维度 | 可编辑违规判定维度列表，精准控制 AI 判断标准 |
...
7. 切换到 **📊 统计** 标签查看 Token 消耗与费用估算
8. 切换到 **📋 黑名单** 标签管理拉黑记录，可单条移除或一键清空
9. 控制台执行 `__ruozhi_diag()` 查看诊断信息
